        ...
        <tr>
          <td style="padding:32px 32px 8px 32px;">
            ...
            <table role="presentation" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td style="background-color:#e8f5ee; color:#2d7a4f; font-family: Arial, Helvetica, sans-serif; font-size:11px; font-weight:bold; letter-spacing:.06em; text-transform:uppercase; padding:6px 14px; border-radius:20px;">
                  Recordatorio &middot; {{ $antelacionLabel }}
                </td>
              </tr>
            </table>
            ...
            <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 16px 0;">
              <tr>
                <td style="font-family: Arial, Helvetica, sans-serif; font-size:14px; line-height:22px; color:#33403a;">
                  <strong>Fecha:</strong> {{ $fechaLabel }}<br>
                  <strong>Hora:</strong> {{ $horaLabel }}
                  @if (! empty($ubicacion))
            ...
            @if (! empty($descripcion))
              <p style="margin:0 0 20px 0; font-family: Arial, Helvetica, sans-serif; font-size:15px; line-height:24px; color:#33403a; white-space:pre-line;">{{ $descripcion }}</p>
            @endif

            <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 8px 0;">
              <tr>
                <td style="background-color:#2d7a4f; border-radius:6px;">
                  <a href="{{ $urlCalendario }}" style="display:inline-block; padding:12px 24px; font-family: Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold; color:#ffffff; text-decoration:none;">
        ...
        <tr>
          <td style="padding:20px 32px 28px 32px; font-family: Arial, Helvetica, sans-serif;">
            <p style="margin:0 0 8px 0; font-size:12px; line-height:18px; color:#6b7a70;">
              Este es un recordatorio automático del <strong>{{ $colegioNombre }}</strong>. No respondas a este correo.
            </p>
