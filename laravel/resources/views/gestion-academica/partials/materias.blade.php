<div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
    <div class="row g-3 flex-grow-1 mb-0">
        @foreach ([
            ['label' => 'Total', 'value' => $resumenMaterias['total'], 'color' => 'primary'],
            ['label' => 'Activas', 'value' => $resumenMaterias['activas'], 'color' => 'success'],
            ['label' => 'Inactivas', 'value' => $resumenMaterias['inactivas'], 'color' => 'secondary'],
        ] as $stat)
            <div class="col-4">
