...
@section('content')
    <div class="container-fluid p-3 p-md-4" style="max-width: 700px;">
        <div class="d-flex align-items-center gap-2 mb-3">
            ...
            <h1 class="h4 fw-semibold font-serif mb-0">Registro de docentes</h1>
        </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="primer_nombre" id="primer_nombre" data-feedback="err-primer_nombre" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="primer_apellido" id="primer_apellido" data-feedback="err-primer_apellido" required>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="profesion" id="profesion" placeholder="Ej. Licenciado en Matemáticas">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Especialidad</label>
                            <input type="text" class="form-control" name="especialidad" id="especialidad" placeholder="Ej. Educación básica">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Fecha de ingreso</label>
                            <input type="date" class="form-control" name="fecha_ingreso" id="fecha_ingreso" value="{{ now()->toDateString() }}">
                        </div>
                    </div>
            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="ms-auto d-flex gap-2">
                    ...
                    <button type="submit" class="btn btn-primary d-none" id="btnGuardar" data-wizard-only-last>
                        <i class="fas fa-save me-1"></i> Registrar docente
                    </button>
                </div>
            </div>
        </form>
