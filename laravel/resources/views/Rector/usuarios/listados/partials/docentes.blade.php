...
<form method="GET" action="{{ route('listados.docentes.index') }}" class="row g-2 mb-3 align-items-center" data-autosubmit-form>
    ...
    <div class="col-md-2 d-grid">
        <a href="{{ route('listados.docentes.index') }}" class="btn btn-outline-secondary btn-sm">Limpiar filtros</a>
    </div>
</form>
                        ...
                        <td class="text-end">
                            ...
                            @else
                                <button type="button" class="btn btn-sm btn-outline-success" data-activar
                                        data-url="{{ route('listados.docentes.activar', $docente) }}"
                                        data-nombre="{{ trim($docente->usuario->nombres.' '.$docente->usuario->apellidos) }}"
                                        title="Reactivar">
