...
<div class="container-fluid p-3 p-md-4">
    <h1 class="h4 fw-semibold font-serif mb-3">Horarios</h1>
    ...
    @else
        ...
        @if ($asignacionesHorario->isEmpty())
            <div class="empty-state">
                <div class="empty-icon"><i class="fas fa-calendar-week"></i></div>
                <p class="mb-2">Este curso todavía no tiene materias asignadas. Asignale al menos una materia y profesor para poder armar el horario.</p>
                <a href="{{ route('gestion-academica.asignaciones.index', ['curso' => $cursoHorarioId]) }}" class="btn btn-sm btn-primary">
                    Ir a Asignaciones
                </a>
            </div>
        @else
