...
use App\Http\Requests\Registro\AdministrativoStoreRequest;
use App\Http\Requests\Registro\AdministrativoUpdateRequest;
...
class RegistroAdministrativosController extends Controller
{
    ...
    {
        return view('panel.registro.administrativos', ['currentPage' => 'RegistroAdministrativos', 'admin' => null]);
    }
    ...
    {
        return view('panel.registro.administrativos', ['currentPage' => 'RegistroAdministrativos', 'admin' => $usuario]);
    }
