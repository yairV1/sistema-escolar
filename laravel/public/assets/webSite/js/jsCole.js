...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function animateCounters() {
    const counters = [
      document.querySelector('.stat:nth-child(1) strong'),
      document.querySelector('.stat:nth-child(3) strong'),
      document.querySelector('.stat:nth-child(5) strong'),
    ];
    counters.forEach((el) => {
      if (!el) return;
      // El valor y sufijo se leen del contenido real del HTML (editable
      // desde el CMS de Editar Landing) en vez de estar fijos acá.
