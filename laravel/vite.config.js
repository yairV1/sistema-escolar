    ...
    plugins: [
        laravel({
            input: [
                ...
                'resources/js/pages/calificaciones/observaciones.js',
                'resources/js/pages/calificaciones/escala-notas.js',
                'resources/js/pages/observaciones/observaciones.js',
                'resources/js/pages/boletines/boletines.js',
                'resources/js/pages/director-grupo/index.js',
                'resources/js/pages/director-grupo/notas.js',
                ...
                'resources/js/pages/docente/comunicados.js',
